...
import { SOClient } from "./SOClient.js";
export class SOConnection {
  ...
  // ---------------- Client lifecycle ----------------
  createClient() {
    return new SOClient(this._config.host, this._config.application, this._config.deviceWidth, this._config.deviceHeight, this._config.secured, this._config.apiKey);
  }
  reset() {
    this._client = this.createClient();
    this._lastUsername = "";
